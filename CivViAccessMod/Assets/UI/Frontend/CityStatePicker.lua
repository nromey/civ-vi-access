...
-- (Controls, LuaEvents.CityStatePicker_Initialize, ParameterInitialize)
-- exist before our companion's BaseMenu.install captures the input
-- handler.
include("ScreenReader");
include("CityStatePickerAccess");