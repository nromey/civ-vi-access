...
-- Civ VI Access: keyboard navigation + screen-reader speech for this screen.
-- Loaded after Initialize() so OnShow / OnHide / OnInputHandler globals
-- exist and Initialize() has registered them on ContextPtr before our
-- companion's BaseMenu.install wraps them.
include("ScreenReader");
include("AdvancedSetupAccess");