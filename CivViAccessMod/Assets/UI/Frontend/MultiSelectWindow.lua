...
-- (Controls table, LuaEvents.MultiSelectWindow_Initialize, ParameterInitialize)
-- exist before our companion's BaseMenu.install captures the input handler.
include("ScreenReader");
include("MultiSelectWindowAccess");