...
-- Accessibility companion. Loaded last so the base Context's globals
-- (Controls, g_GameParameters, OnDefaultButton / OnStartButton /
-- OnBackButton / OnAddAIButton, UI_PostRefreshParameters) exist
-- before our companion's BaseMenu.install captures the input handler.
include("ScreenReader");
include("ScenarioSetupAccess");